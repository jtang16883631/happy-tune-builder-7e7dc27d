...
import { ClipboardCheck, Loader2, WifiOff } from 'lucide-react';
        ...
        <CardContent className="pt-4 space-y-4">
          {isOnline ? (
            ...
            <>
              ...
              <div className="text-center text-sm text-muted-foreground">
                <p>Access scan and FDA data stored on this device.</p>
                <p className="mt-1">Sign in with Google when you're back online.</p>
              </div>
            </>
          )}
        </CardContent>
